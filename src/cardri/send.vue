          ...
          <form @submit.prevent="sendData">
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
              <div
                ...
                style="align-items: center; margin-bottom: 10px"
              >
                <label for="Wallet">Description</label>
              </div>
              <textarea
                type="text"
                class="form-control"
            ...
            <label class="containerss"
              ...
              <input type="checkbox" v-model="bns" />
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="sendForeign">
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
              <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
                <div
                  ...
                  style="align-items: center; margin-bottom: 10px"
                >
                  <label for="Wallet">Beneficiary</label>
                </div>
                <select
                  type="text"
                  ...
                  @change="geteachbeneficiary"
                >
                  <option :value="item" v-for="item in beneficiary" :key="item">
                    {{ item.fname }} {{ item.lname }} {{ item.c_name }}
                  </option>
                </select>
              </div>
            </div>
            ...
            <div
              ...
              style="align-items: center; margin-bottom: 10px"
            >
              <label for="Wallet">Beneficiary Country</label>
            </div>
            <input
              type="text"
              class="form-control"
              v-model="foreigncountry"
              required
              readonly
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
              <div
                ...
                style="align-items: center; margin-bottom: 10px"
              >
                <label for="Wallet">Beneficiary Currency</label>
              </div>
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
              ...
              >
                <label for="Wallet"
                  >Amount {{ wallet != undefined ? `In ${wallet}` : "" }}</label
                >
              </div>
              <input
                type="tel"
            ...
            <div class="form-group" style="margin-top: 20px; margin-bottom: 20px">
              <div
                ...
                style="align-items: center; margin-bottom: 10px"
              >
                <label for="Wallet">Purpose </label>
              </div>
              <select
                required
                class="form-control"
              ...
              >
                <option :value="item.id" v-for="item in purposes" :key="item">
                  {{ item.title }}
                </option>
              </select>
            </div>
...
export default {
  ...
  methods: {
    ...
    async sendData() {
      const data = {
        amount: this.amount,
        accountcode: this.bankCode.code,
        bankname: this.bankCode.name,
        naration: this.description,
        bns: this.bns,
        accountname: this.loadermessage,
