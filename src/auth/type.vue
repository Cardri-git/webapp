  ...
  <div class="container-xxl">
    ...
    <div class="container">
      ...
      <div class="mybodytag">
        ...
        <p>We will send an OTP to {{ config }}. Don’t share it with anyone.</p>
        <form @submit.prevent="sendOtps">
          <div class="row d-flex justify-content-center">
            <div class="col">
              <label class="containers"
                >SMS
                <input type="checkbox" checked="checked" name="mycheck" />
          ...
          <h5
            ...
            @click="getback"
          >
            <span class="material-icons">arrow_back</span>Back to Registration
          </h5>
        </form>
      </div>
    </div>
